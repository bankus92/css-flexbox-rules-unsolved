...
- [c] All the tasks of the "Specific requirements" section MUST be solved
- [c] The project's file/folder structure should NOT be edited!
- [c] The ecommerce-page.html file should NOT be edited!
...
- [c] Push the changes to the Github repo, when finished.
- [c] Submit a .txt file with the Github repo url.
